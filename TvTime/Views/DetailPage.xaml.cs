    ...
    public sealed partial class DetailPage : Page, INotifyPropertyChanged
    {
        ...
        public List<LocalItem> GetServerDetails(string content, LocalItem localItem)
        {
            ...
            foreach (Match m in m1)
            {
                ...
                if ((i.Server.Contains(".mp4", StringComparison.OrdinalIgnoreCase) || i.Server.Contains(".mkv", StringComparison.OrdinalIgnoreCase)) && fileSizeMatches.Count > 0 && index <= fileSizeMatches.Count)
                {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (server.Contains(".mp4") || server.Contains(".mkv"))
            {
